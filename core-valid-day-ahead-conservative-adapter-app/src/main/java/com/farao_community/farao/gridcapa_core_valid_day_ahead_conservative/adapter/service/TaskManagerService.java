...
public class TaskManagerService {
    ...
    public TaskManagerService(final RestTemplateBuilder restTemplateBuilder,
                              final CoreValidD2ConservativeAdapterConfiguration coreAdapterConfiguration) {
        this.restTemplateBuilder = restTemplateBuilder;
        this.taskManagerTimestampBaseUrl = coreAdapterConfiguration.taskManagerTimestampUrl();
    }
